...
llab.paths.scripts[2].push(llab.rootURL + "script/process_html.js")
...
llab.paths.css_files.push('/apcsa/r/static/css/ucb_apcsa.css');
...
llab.topic_launch_page = llab.rootURL + "topic/topic.html";
...
llab.config.defaultCourseStartTime = new Date(2016, 07, 20, 12);
