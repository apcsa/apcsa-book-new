...
// TODO put this in config file please
var PAGE_SERVER_ROOT = "http://ec2-54-153-35-4.us-west-1.compute.amazonaws.com";
    ...
    if ($(APCSA_SPECS.full_selector + " " + "span.vocab").length > 0) {
        ...
        $("span.vocab").each(
                function(i) {
                    ...
                    // TODO
                    vocabDiv.append('<a href="' + PAGE_SERVER_ROOT + '/apcsa/page/glossary.php?term='
    ...
    if ($(APCSA_SPECS.full_selector + " " + "span.help").length > 0) {
        ...
        $(APCSA_SPECS.full_selector + " " + "span.help").each(
                function(i) {
                    ...
                    // TODO
                    helpDiv.append('<p><a href="' + PAGE_SERVER_ROOT + '/apcsa/page/help.php?topic='
